...
class Venta
{
    ...
    {
        echo "$this->id,$this->mailUsuario,$this->sabor, $this->tipo,$this->cantidad,$this->fechaDePedido";
    }
    ...
    public static function jsonToVenta($arrayJson)
    {
        ...
        foreach ($arrayJson as $auxJson) {
            ...
            $auxSabor = $auxJson["sabor"];
            $auxTipo = $auxJson["tipo"];
            $auxCantidad = $auxJson["cantidad"];
